...
/**
 * The <b>SVNProperties</b> class represents an object wrapper for <code>String</code> to 
 * {@link SVNPropertyValue} mappings where <code>String</code> keys represent property names and 
 * values - property values wrapped in {@link SVNPropertyValue} objects.
 * 
 * <p>
 * This class is backed by a <code>Map</code> object and brings specific methods useful for working with 
...
public class SVNProperties implements Cloneable, Serializable {
     ...
     * 
     * <p/>
     * <code>map</code> is not stored by this object, instead its contents are copied into a new 
     * <code>Map</code> object (which will be backed by a new <code>SVNProperties</code> object) 
     * according to the following rules:
     * 
     * <ul>
     * <li/>if the value is of type <code>String</code>, then it's wrapped into {@link SVNPropertyValue} using 
     * the {@link SVNPropertyValue#create(String)} method;
     * <li/>if the value is of type <code>byte[]</code>, then it's wrapped into {@link SVNPropertyValue} using
     * the {@link SVNPropertyValue#create(String, byte[])} method;
     * <li/>if the value is of type {@link SVNPropertyValue}, then it's not copied but is put into a new map 
     * as is;
     * </ul> 
     * 
     * @param  map  initial map holding properties
     * @return      <code>SVNProperties</code> object; if <code>map</code> is 
     *              <span class="javakeyword">null</span>, returns an empty <code>SVNProperties</code> object
     *              created as <code>new SVNProperties()</code> 
     * @see         #SVNProperties()          
     */
    ...
    /**
     * Stores a new mapping <code>propertyName</code> to <code>propertyValue</code> in 
     * this object.
     * 
     * @param propertyName  property name 
     * @param propertyValue property value object
     */
     ...
     * 
     * <p>
     * <code>propertyValue</code> is converted to an {@link SVNPropertyValue} object through 
     * a call to {@link SVNPropertyValue#create(String)}.
     * 
     * @param propertyName  property name 
     * @param propertyValue property value string
     */
     ...
     * <p>
     * <code>propertyValue</code> is converted to an {@link SVNPropertyValue} object through 
     * a call to {@link SVNPropertyValue#create(String, byte[])}.
     * 
     * @param propertyName  property name 
     * @param propertyValue property value bytes
     */
     ...
     *  
     * @param  propertyName property name 
     * @return              property value string; <span class="javakeyword">null</span> if there's no such 
     *                      property or if it's not a <code>String</code> property value 
     */
     ...
     * 
     * @param  propertyName  property name 
     * @return               byte array containing property value bytes; <span class="javakeyword">null</span> 
     *                       if there's no such property or if it's not a binary property value 
     */
     ...
     * @param  propertyName  property name 
     * @return               property value object; <span class="javakeyword">null</span> if there's no such 
     *                       property
     */
     ...
     * 
     * @param  propertyName  name of the property to remove from this object
     ...
     * 
     * @return <span class="javakeyword">true</span> if this object holds no properties; otherwise 
    ...
    /**
     * Removes all mappings which values are <span class="javakeyword">null</span>s from this object.
     */
     ...
     * 
     * @param propertyName   property name 
     * @return               <span class="javakeyword">true</span> if this object contains a mapping with
     *                       the specified key (<code>propertyName</code>)
     */
     ...
     * @return                <span class="javakeyword">true</span> if this object contains <code>value</code>
     *                        
     */
    ...
    /**
     * Returns a subset of properties contained in this properties object which suffice for 
     * {@link SVNProperty#isRegularProperty(String)} clause.
     * 
     * @return regular properties; if there are no properties which would suffice the aforementioned clause, 
     *         an empty <code>SVNProperties</code> object is returned   
     */
     ...
     * 
     * <p/>
     * Properties which are present in this object but are not in <code>properties</code>, are put to 
     * the result as property name to <span class="javakeyword">null</span> mappings. Properties which are 
     * present only in <code>properties</code> but not in this object, are added to the result. Also result will 
     * include those properties which are present in both objects but have different values; in this case result
     * will include such properties with values from <code>properties</code>. 
     * 
