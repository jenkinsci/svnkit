 ...
 */
public class SVNStatusClient16 extends SVNBasicDelegate {
	...
	public long doStatus(File path, boolean recursive, boolean remote,
			...
			throws SVNException {
		return doStatus(path, SVNRevision.HEAD,
				SVNDepth.fromRecurse(recursive), remote, reportAll,
				includeIgnored, false, handler, null);
	}
	...
	public long doStatus(File path, boolean recursive, boolean remote,
		...
		return doStatus(path, SVNRevision.HEAD,
				SVNDepth.fromRecurse(recursive), remote, reportAll,
				includeIgnored, collectParentExternals, handler, null);
	}
	...
	public long doStatus(File path, SVNRevision revision, boolean recursive,
			...
			boolean collectParentExternals, final ISVNStatusHandler handler)
			throws SVNException {
		return doStatus(path, revision, SVNDepth.fromRecurse(recursive),
	...
	public SVNStatus doStatus(File path, boolean remote,
		...
		doStatus(absPath, SVNRevision.HEAD, SVNDepth.EMPTY, remote, true, true,
