 ...
 */
public class SVNWCDataBaseStorage {
    ...
    private SVNWCDataBaseStorage() {
    }
    
    public static SVNWCDataBaseStorage initDB(File path, String reposRoot, String reposRelativePath, String reposUUID, 
        ...
        SVNWCDataBaseStorage wcDB = new SVNWCDataBaseStorage();
