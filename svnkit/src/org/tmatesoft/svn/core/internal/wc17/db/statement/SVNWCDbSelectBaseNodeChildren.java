 ...
 */
public class SVNWCDbSelectBaseNodeChildren extends SVNSqlJetSelectFieldsStatement<SVNWCDbSchema.BASE_NODE__Fields> {
    ...
    protected void defineFields() {
        fields.add(SVNWCDbSchema.BASE_NODE__Fields.local_relpath);
    }
