 ...
 * @since   1.2
 */
public class SVNLogClient17 extends SVNBasicDelegate {
	 ...
	 */
	public SVNLogClient17(ISVNAuthenticationManager authManager,
			ISVNOptions options) {
	 ...
	 * @param options          a run-time configuration options driver
	 */
	public SVNLogClient17(ISVNRepositoryPool repositoryPool, ISVNOptions options) {
