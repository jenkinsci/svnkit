...
public class SVNChangelistClient17 extends SVNBasicDelegate {
	 ...
	 */
	public SVNChangelistClient17(ISVNAuthenticationManager authManager,
			ISVNOptions options) {
	 ...
	 * @param options          a run-time configuration options driver
	 */
	public SVNChangelistClient17(ISVNRepositoryPool repositoryPool,
			ISVNOptions options) {
	 ...
	 * instead
	 */
	public void getChangeLists(File path, final Collection changeLists,
	 ...
	 * @param handler 
	 * @throws SVNException
	 * @deprecated           use {@link #doGetChangeListPaths(Collection,Collection,SVNDepth,ISVNChangelistHandler)}instead 
	 */
	public void getChangeListPaths(Collection changeLists, Collection targets,
			SVNDepth depth, ISVNChangelistHandler handler) throws SVNException {
	 ...
	 */
	public void addToChangelist(File[] paths, SVNDepth depth,
			String changelist, String[] changelists) throws SVNException {
	 ...
	 */
	public void removeFromChangelist(File[] paths, SVNDepth depth,
	 ...
	 */
	public void doAddToChangelist(File[] paths, SVNDepth depth,
			String changelist, String[] changelists) throws SVNException {
	 ...
	 * @since                  1.2.0, New in SVN 1.5.0
	 */
	public void doRemoveFromChangelist(File[] paths, SVNDepth depth,
			String[] changelists) throws SVNException {
		SVNErrorMessage err = SVNErrorMessage
				.create(SVNErrorCode.WC_UNSUPPORTED_FORMAT);
		SVNErrorManager.error(err, SVNLogType.CLIENT);
	 ...
	 * @throws SVNException 
	 */
	public void doGetChangeListPaths(Collection changeLists,
			Collection targets, SVNDepth depth, ISVNChangelistHandler handler)
			throws SVNException {
		SVNErrorMessage err = SVNErrorMessage
				.create(SVNErrorCode.WC_UNSUPPORTED_FORMAT);
		SVNErrorManager.error(err, SVNLogType.CLIENT);
