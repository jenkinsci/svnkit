...
public class Version {
    ...
    private static final String VERSION_STRING_DEFAULT = "SVN/1.7.11 SVNKit/1.7.11 (http://svnkit.com/) rSNAPSHOT";
    ...
    private static final String SVN_VERSION_DEFAULT = "1.7.11";
