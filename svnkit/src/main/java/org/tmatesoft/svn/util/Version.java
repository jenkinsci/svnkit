...
public class Version {
    ...
    private static final String VERSION_STRING_DEFAULT = "SVN/1.7.5 SVNKit/1.7.5-v1 (http://svnkit.com/) rSNAPSHOT";
    ...
    private static final String SVN_VERSION_DEFAULT = "1.7.5-v1";
