...
public class SVNCopyClient17 extends SVNCopyDriver {
     ...
     */
    public SVNCopyClient17(ISVNAuthenticationManager authManager, ISVNOptions options) {
     ...
     *            a run-time configuration options driver
     */
    public SVNCopyClient17(ISVNRepositoryPool repositoryPool, ISVNOptions options) {
