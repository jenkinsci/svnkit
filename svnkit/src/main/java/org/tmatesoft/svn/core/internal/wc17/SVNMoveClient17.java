...
public class SVNMoveClient17 extends SVNCopyDriver {
     ...
     */
    public SVNMoveClient17(ISVNAuthenticationManager authManager, ISVNOptions options) {
     ...
     *            a run-time configuration options driver
     */
    public SVNMoveClient17(ISVNRepositoryPool repositoryPool, ISVNOptions options) {
