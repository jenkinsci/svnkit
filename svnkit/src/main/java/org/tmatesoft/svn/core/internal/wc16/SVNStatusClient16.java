        ...
        try {
            ...
            if (remote) {
                ...
                if (kind == SVNNodeKind.NONE) {
                    ...
                    reporter = new SVNReporter(info, path, false, !serverSupportsDepth, depth, false, true, true, getDebugLog());
                ...
                if (getEventDispatcher() != null) {
                    ...
                    SVNEvent event = SVNEventFactory.createSVNEvent(info.getAnchor().getFile(info.getTargetName()), SVNNodeKind.NONE, null, editor.getTargetRevision(),
