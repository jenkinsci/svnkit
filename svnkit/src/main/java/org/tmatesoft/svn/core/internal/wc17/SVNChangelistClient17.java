...
public class SVNChangelistClient17 extends SVNBasicDelegate {
     ...
     */
    public SVNChangelistClient17(ISVNAuthenticationManager authManager, ISVNOptions options) {
     ...
     *            a run-time configuration options driver
     */
    public SVNChangelistClient17(ISVNRepositoryPool repositoryPool, ISVNOptions options) {
     ...
     * @param changelists
     * @throws SVNException
     * @deprecated use {@link #doRemoveFromChangelist(File[],SVNDepth,String[])}
     *             instead
     */
