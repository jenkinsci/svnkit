...
public class ISvnDiffCallbackWrapper implements ISvnDiffCallback2 {

    private final ISvnDiffCallback callback;
    private final boolean deleteDirs;
    private final File anchorAbsPath;

    public ISvnDiffCallbackWrapper(ISvnDiffCallback callback, boolean deleteDirs, File anchorAbsPath) {
