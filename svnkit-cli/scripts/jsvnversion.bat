...
set SVNKIT_CLASSPATH= "%SVNKIT_HOME%svnkit.jar";"%SVNKIT_HOME%svnkit-cli.jar";"%SVNKIT_HOME%trilead.jar";"%SVNKIT_HOME%sqlitejdbc.jar";"%SVNKIT_HOME%jna.jar"
set SVNKIT_MAINCLASS=org.tmatesoft.svn.cli2.svnversion.SVNVersion
