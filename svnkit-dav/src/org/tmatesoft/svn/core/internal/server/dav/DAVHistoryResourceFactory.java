 ...
 */
public class DAVHistoryResourceFactory extends DAVResourceFactory {
    ...
    protected DAVResource createDAVResourceImpl(SVNRepository repository, DAVResourceURI resourceURI, boolean isSVNClient, String deltaBase, 
        ...
        return new DAVHistoryResource(repository, resourceURI, isSVNClient, deltaBase, version, clientOptions, baseChecksum, resultChecksum, 
