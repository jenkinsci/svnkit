 ...
 */
public class DAVActivityResource extends DAVResource {
    
    public DAVActivityResource(SVNRepository repository, DAVResourceURI resourceURI, boolean isSVNClient, String deltaBase, long version, 
    ...
    public DAVActivityResource(SVNRepository repository, DAVResourceURI resourceURI, long revision, boolean isSVNClient, String deltaBase, 
