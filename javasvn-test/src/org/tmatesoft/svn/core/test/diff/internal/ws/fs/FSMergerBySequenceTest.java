...
public class FSMergerBySequenceTest extends TestCase {
	...
	private void test(String baseFile, String baseEol, String localFile, String localEol, String latestFile, String latestEol, String resultFile, String resultEol, int expectedStatus) throws IOException {
		...
		final int status = merger.merge(new ByteArrayInputStream(baseFile.getBytes()), new ByteArrayInputStream(localFile.getBytes()), new ByteArrayInputStream(latestFile.getBytes()), result);
