...
public class SVNStatus {
    ...
    public SVNStatus(String path, int propStatus, int contentsStatus,
            long revision, long wcRevision, boolean addedWithHistory,
            boolean switched, boolean isDirectory, String author, SVNLock lock) {
        this(path, propStatus, contentsStatus, revision, wcRevision, -1, 0, 0,
                addedWithHistory, switched, isDirectory, author, lock);

    }

    public SVNStatus(String path, int propStatus, int contentsStatus,
            long revision, long wcRevision, long remoteRevision,
            int remoteContentsStatus, int remotePropsStatus,
            boolean addedWithHistory, boolean switched, boolean isDirectory,
            String author) {
        this(path, propStatus, contentsStatus, revision, wcRevision,
                remoteRevision, remoteContentsStatus, remotePropsStatus,
                addedWithHistory, switched, isDirectory, author, null);
    }
    ...
    public void setRemoteStatus(long revision, int propStatus,
            int contentsStatus, String lockToken) {
