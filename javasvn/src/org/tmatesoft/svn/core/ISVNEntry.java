...
public interface ISVNEntry {
    ...
    /**
     * Returns entry or working copy property value. Returns actual custom
     * property value.
     * 
     * @param name
     */
    ...
    /**
     * Modifies entry or working copy property value. Modifies actual custom
     * propety value making this entry modified.
     * 
     * @param name
     * @param value
     */
    ...
    /**
     * Sends modified properties (i.e. custom properties that were changed since
     * the last merge) to the editor
     */
    ...
    /**
     * Dismiss all the information stored in memory. Called after save() or
