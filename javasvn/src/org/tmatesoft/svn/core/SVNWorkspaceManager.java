...
public class SVNWorkspaceManager {
    ...
    public static ISVNWorkspace createWorkspace(String type, String rootID)
            throws SVNException {
        if (ourFactories != null && type != null) {
            ISVNEntryFactory factory = (ISVNEntryFactory) ourFactories
                    .get(type);
            if (factory != null) {
                ...
                throw new SVNException("can't locate root factory for type "
                        + type);
            }
        }
        return null;
    ...
    protected static void registerRootFactory(String type,
            ISVNEntryFactory factory) {
