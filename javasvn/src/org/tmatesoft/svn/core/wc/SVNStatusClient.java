...
public class SVNStatusClient extends SVNBasicClient {
    ...
    private Map collectParentExternals(File path, boolean asTarget)
            throws SVNException {
        ...
        do {
            ...
            String externalsProperty = wcAccess.getAnchor().getProperties("",
                    false).getPropertyValue(SVNProperty.EXTERNALS);
            if (externalsProperty != null) {
                ...
                for (int i = 0; i < infos.length; i++) {
                    ...
                    if (infoPath.equals(currentPath)) {
                        ...
                        // below target dir.
                        info.setPath(infoPath.substring((currentPath + "/")
                                .length()));
                        if (asTarget) {
