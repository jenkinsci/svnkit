 ...
 * @version 1.3
 */
public class ChangeMergeTargetCopyFromPathTest3 extends AbstractExtMergeTest {
    ...
    public void run() throws SVNException {
	    ...
	    final long lastRevision = getEnvironment().modifyAndCommit(getBranchFile("B/file2"));

	    mergeLastRevisions(getBranch(), getTrunkWC(), lastRevision, SVNDepth.INFINITY, false, false);
