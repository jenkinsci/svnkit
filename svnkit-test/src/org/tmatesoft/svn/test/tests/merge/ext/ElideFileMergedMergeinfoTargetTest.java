 ...
 * @version 1.2.0
 */
public class ElideFileMergedMergeinfoTargetTest extends AbstractExtMergeTest {
    ...
    public void run() throws SVNException {
        ...
        getEnvironment().copy(getTrunkFile("A/file"), SVNRevision.WORKING, getTrunkFile("A/file_renamed"), true, false, true);
        getEnvironment().commit(getTrunkWC(), "A/file renamed to A/file_renamed", SVNDepth.INFINITY);
