 ...
 * @version 1.3
 */
public class MergeRenamedDirSourceTest2 extends MergeRenamedDirSourceTest {
    ...
    protected void doMerge(long startRevision, long endRevision) throws SVNException {
        mergeLastRevisions(getBranch(), getTrunkWC(), endRevision - startRevision + 1, SVNDepth.INFINITY, false, false);
    }
